...
```{r PlotRegresores_estatico_std, cache=TRUE, dependson=c('GLM_Estatico_Std') fig.width=12,fig.height=8,fig.cap='\\label{fig:Regresores_Estatico_Std}Regresores vs WTI: Modelo \\eqref{eq:mod_estatico_Std}'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r tsBetas_dinam_std,cache=TRUE, dependson=c('GLM_Dinamico_Std'), message=FALSE, warning=FALSE, fig.width=12,fig.height=8,fig.cap='\\label{fig:tsBetas_Dinam_Std}Coeficientes Estimados: Modelo  \\eqref{eq:mod_dinam_Std}'}
#betas
par(mfrow=c(3,2))
...
```{r PlotRegresores_dinam_std_suav10, cache=TRUE, dependson=c('GLM_Dinamico_suav_10_Std'),fig.width=12,fig.height=6,fig.cap='\\label{fig:PlotRgresroes_Dinam_suav10_Std}Regresores vs WTI: Modelo \\eqref{eq:mod_dinam_suav_10_Std}'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r tsWTI_dinam_std_suav_10, cache=TRUE, dependson=c('GLM_Dinamico_suav_10_Std'), fig.width=12,fig.height=6,fig.cap='\\label{fig:tsWTI_Dinam_suav_10_Std}Ajuste y Predicción: Modelo \\eqref{eq:mod_dinam_suav_10_Std}'}
#t vs y
par(mfrow=c(1,1))
...
```{r tsBetas_dinam_std_suav_10,cache=TRUE, dependson=c('GLM_Dinamico_suav_10_Std'), message=FALSE, warning=FALSE, fig.width=12,fig.height=8,fig.cap='\\ref{fig:tsBetas_Dinam_suav_10_Std}Coeficientes Estimados: Modelo \\eqref{eq:mod_dinam_suav_10_Std}'}
#betas
par(mfrow=c(3,2))
...
```{r PlotRegresores_dinam_std_suav_100,cache=TRUE, dependson=c('GLM_Dinamico_suav_100_Std'), fig.width=12,fig.height=6,fig.cap='\\label{fig:PlotRegresores_Dinam_suav100_Std}Regresores vs WTI: Modelo \\eqref{eq:mod_dinam_suav_100_Std}'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r tsWTI_dinam_std_suav_100,fig.width=12,cache=TRUE, dependson=c('GLM_Dinamico_suav_100_Std'),fig.height=6,fig.cap='\\label{fig:tsWTI_Dinam_suav_100_Std}Ajuste y Predicción: Modelo \\eqref{eq:mod_dinam_suav_100_Std}'}
#t vs y
par(mfrow=c(1,1))
...
```{r tsBetas_dinam_std_suav_100,message=FALSE, cache=TRUE, dependson=c('GLM_Dinamico_suav_100_Std'), warning=FALSE, fig.width=12,fig.height=8,fig.cap='\\label{fig:tsBetas_Dinam_suav_100_std}Coeficientes Estimados: Modelo \\eqref{eq:mod_dinam_suav_100_Std}'}
#betas
par(mfrow=c(3,2))
...
```{r PlotRegresores_dinam_std2_suav_1000,cache=TRUE, dependson=c('GLM_Dinamico_suav_1000_Std'), fig.width=12,fig.height=6,fig.cap='\\label{fig:PlotRegresores_Dinam_suav_1000_Std}Regresores vs WTI: Modelo \\eqref{eq:mod_dinam_suav_1000_Std}'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r tsWTI_dinam_std_suav_1000,cache=TRUE, dependson=c('GLM_Dinamico_suav_1000_Std'), fig.width=12,fig.height=6,fig.cap='\\label{fig:tsWTI_Dinam_suav_1000_Std}Ajuste y Predicción: Modelo \\eqref{eq:mod_dinam_suav_1000_Std}'}
#t vs y
par(mfrow=c(1,1))
...
```{r tsBetas_dinam_std_suav_1000,cache=TRUE, dependson=c('GLM_Dinamico_suav_1000_Std'), message=FALSE, warning=FALSE, fig.width=12,fig.height=8,fig.cap='\\label{fig:tsWTI_Dinam_suav_1000_Std}Coeficientes Estimados: Modelo \\eqref{eq:mod_dinam_suav_1000_Std}'}
#betas
par(mfrow=c(3,2))
