...
```{r tsWTI_RegLin, cache=TRUE, dependson=c('GLM_Dinamico_suav_10'),fig.width=12,fig.height=6,fig.cap='\\label{fig:tsWTI_RegLin}Ajuste y Predicción: Modelo \\eqref{eq:RegLin}'}
#t vs y
par(mfrow=c(1,1))
...
```{r PlotRegresores_Dinam_suav10, cache=TRUE, dependson=c('GLM_Dinamico_suav_10'), fig.width=12,fig.height=10,fig.cap='\\label{fig:PlotRgresroes_Dinam_suav10}Regresores vs WTI: Modelo \\eqref{eq:mod_dinam_suav_10}'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r tsWTI_Dinam_suav_10, cache=TRUE, dependson=c('GLM_Dinamico_suav_10'),fig.width=12,fig.height=6,fig.cap='\\label{fig:tsWTI_Dinam_suav_10}Ajuste y Predicción: Modelo \\eqref{eq:mod_dinam_suav_10}'}
#t vs y
par(mfrow=c(1,1))
...
```{r tsBetas_Dinam_suav_10, cache=TRUE, dependson=c('GLM_Dinamico_suav_10'),message=FALSE, warning=FALSE, fig.width=12,fig.height=10,fig.cap='\\ref{fig:tsBetas_Dinam_suav_10}Coeficientes Estimados: Modelo \\eqref{eq:mod_dinam_suav_10}'}
#betas
par(mfrow=c(3,2))
...
```{r PlotRegresores_Dinam2_suav100,fig.width=12,fig.height=10,fig.cap='\\label{fig:PlotRegresores_Dinam_suav100}Regresores vs WTI: Modelo \\eqref{eq:mod_dinam_suav_100}'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r tsBetas_Dinam_suav_100,message=FALSE, warning=FALSE, fig.width=12,fig.height=8,fig.cap='\\label{fig:tsBetas_Dinam_suav_100}Coeficientes Estimados: Modelo \\eqref{eq:mod_dinam_suav_100}'}
#betas
par(mfrow=c(3,2))
...
```{r PlotRegresores_Dinam2_suav_100000,cache=TRUE,dependson=c('GLM_Dinamico_suav_100000'),fig.width=12,fig.height=10,fig.cap='\\label{fig:PlotRegresores_Dinam2_suav_100000}Regresores vs WTI: Modelo \\eqref{eq:mod_dinam_suav_100000}'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r tsWTI_Dinam_suav_100000,cache=TRUE,dependson=c('GLM_Dinamico_suav_100000'),fig.width=12,fig.height=6,fig.cap='\\label{fig:tsWTI_Dinam_suav_100000}Ajuste y Predicción: Modelo \\eqref{eq:mod_dinam_suav_100000}'}
#t vs y
par(mfrow=c(1,1))
...
```{r tsBetas_Dinam_suav_100000,cache=TRUE,dependson=c('GLM_Dinamico_suav_100000'),message=FALSE, warning=FALSE, fig.width=12,fig.height=8,fig.cap='\\label{fig:tsWTI_Dinam_suav_100000}Coeficientes Estimados: Modelo \\eqref{eq:mod_dinam_suav_100000}'}
#betas
par(mfrow=c(3,2))
...
En esta sección se utilizan los datos estandarizados.
...
```{r PlotRegresores_estatico_std, cache=TRUE, dependson=c('GLM_Estatico_Std'), fig.pos='H', fig.width=12,fig.height=8,fig.cap='\\label{fig:Regresores_Estatico_Std}Regresores vs WTI: Modelo \\eqref{eq:mod_estatico_Std}'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r tsWTI_estatico_std,cache=TRUE, dependson=c('GLM_Estatico_Std'), fig.width=12,fig.height=6,fig.cap='\\label{fig:tsWTI_Estat_Std}Ajuste y Predicción: Modelo \\eqref{eq:mod_estatico_Std}'}
#t vs y
par(mfrow=c(1,1))
...
```{r PlotRegresores_dinam_std,cache=TRUE, dependson=c('GLM_Dinamico_Std'), fig.pos='H', fig.width=12,fig.height=6,fig.cap='\\label{fig:plotRegresores_dinam_std}Regresores vs WTI: Modelo Dinámico'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r tsBetas_dinam_std,cache=TRUE, dependson=c('GLM_Dinamico_Std'), message=FALSE, warning=FALSE, fig.pos='H', fig.width=12,fig.height=8,fig.cap='\\label{fig:tsBetas_Dinam_Std}Coeficientes Estimados: Modelo  \\eqref{eq:mod_dinam_Std}'}
#betas
par(mfrow=c(3,2))
...
```{r PlotRegresores_dinam_std_suav10, cache=TRUE, dependson=c('GLM_Dinamico_suav_10_Std'),fig.pos='H',fig.width=12,fig.height=6,fig.cap='\\label{fig:PlotRgresroes_Dinam_suav10_Std}Regresores vs WTI: Modelo \\eqref{eq:mod_dinam_suav_10_Std}'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r tsBetas_dinam_std_suav_10,cache=TRUE, dependson=c('GLM_Dinamico_suav_10_Std'), message=FALSE, warning=FALSE, fig.pos='H', fig.width=12,fig.height=8,fig.cap='\\ref{fig:tsBetas_Dinam_suav_10_Std}Coeficientes Estimados: Modelo \\eqref{eq:mod_dinam_suav_10_Std}'}
#betas
par(mfrow=c(3,2))
...
```{r PlotRegresores_dinam_std_suav_100,cache=TRUE, dependson=c('GLM_Dinamico_suav_100_Std'), fig.pos='H', fig.width=12,fig.height=6,fig.cap='\\label{fig:PlotRegresores_Dinam_suav100_Std}Regresores vs WTI: Modelo \\eqref{eq:mod_dinam_suav_100_Std}'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r tsBetas_dinam_std_suav_100,message=FALSE, cache=TRUE, dependson=c('GLM_Dinamico_suav_100_Std'), warning=FALSE, fig.pos='H', fig.width=12,fig.height=8,fig.cap='\\label{fig:tsBetas_Dinam_suav_100_std}Coeficientes Estimados: Modelo \\eqref{eq:mod_dinam_suav_100_Std}'}
#betas
par(mfrow=c(3,2))
...
```{r PlotRegresores_dinam_std2_suav_1000,cache=TRUE, dependson=c('GLM_Dinamico_suav_1000_Std'), fig.pos='H', fig.width=12,fig.height=6,fig.cap='\\label{fig:PlotRegresores_Dinam_suav_1000_Std}Regresores vs WTI: Modelo \\eqref{eq:mod_dinam_suav_1000_Std}'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r tsBetas_dinam_std_suav_1000,cache=TRUE, dependson=c('GLM_Dinamico_suav_1000_Std'), message=FALSE, warning=FALSE, fig.pos='H', fig.width=12,fig.height=8,fig.cap='\\label{fig:tsWTI_Dinam_suav_1000_Std}Coeficientes Estimados: Modelo \\eqref{eq:mod_dinam_suav_1000_Std}'}
#betas
par(mfrow=c(3,2))
...
```{r PlotRegresores_estatico_transf,cache=TRUE, dependson=c('GLM_Estatico_Sin_Intercepto'),fig.width=12,fig.height=10,fig.cap='\\label{fig:PlotRegresores_estatico_transf}Regresores vs WTI: Modelo \\eqref{eq:mod_estatico_transf}'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r PlotRegresores_dinam_suav_10_transf,cache=TRUE,dependson=c('GLM_Dinamico2_suav_10_transf'),fig.pos='H',fig.width=12,fig.height=6,fig.cap='\\label{fig:PlotRegresores_dinam_suav_10_transf}Regresores vs WTI: Modelo \\eqref{eq:mod_dinam_suav_10_transf}'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r tsBetas_dinam_suav_10_transf,cache=TRUE,dependson=c('GLM_Dinamico2_suav_10_transf'),message=FALSE, warning=FALSE, fig.pos='H',fig.width=12,fig.height=8,fig.cap='\\label{fig:tsBetas_dinam_suav_10_transf}Coeficientes Estimados: Modelo \\eqref{eq:mod_dinam_suav_10_transf}'}
...
```{r tsBetas_dinam_suav_100_transf,cache=TRUE,dependson=c('GLM_Dinamico2_suav_100_transf'),message=FALSE, warning=FALSE, fig.pos='H',fig.width=12,fig.height=8,fig.cap='\\label{fig:tsBetas_dinam_suav_100_transf}Coeficientes Estimados: Modelo \\eqref{eq:mod_dinam_suav_10_transf}'}
...
```{r PlotRegresores_dinam_suav_1000_transf,cache=TRUE,dependson=c('GLM_Dinamico2_suav_1000_transf'),fig.pos='H',fig.width=12,fig.height=6,fig.cap='\\label{fig:PlotRegresores_dinam_suav_1000_transf}Regresores vs WTI: Modelo \\eqref{eq:mod_dinam_suav_1000_transf}'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r tsBetas_Dinam_suav_1000_transf,cache=TRUE,dependson=c('GLM_Dinamico2_suav_1000_transf'),message=FALSE, warning=FALSE, fig.pos='H',fig.width=12,fig.height=8,fig.cap='\\label{fig:tsBetas_dinam_suav_1000_transf}Coeficientes Estimados: Modelo \\eqref{eq:mod_dinam_suav_10_transf}'}
...
<!-- ```{r} -->
<!-- comp_modelos<-data_frame(Set=c('Originales','Estandarizados', 'Transformados'),Modelo=c(')) -->
<!-- ``` -->
...
# ```{r CodigosBugs, echo=TRUE, eval=FALSE, include=TRUE}
# 
# ```
