...
EL DIC del modelo es de `r format(out_dinam_suav_10.dic,scipen=999)`.

```{r PlotRegresores_Dinam2_suav10,fig.width=12,fig.height=6,fig.cap='Regresores vs WTI: Modelo Dinámico con Intercepto Estático y Suavizamiento 10'}
#Predictions
par(mfrow=c(3,2))
...
```{r tsBetas_Dinam_suav_10,message=FALSE, warning=FALSE, fig.width=12,fig.height=8,fig.cap='Coeficientes Estimados: Modelo Dinámico'}
#betas
par(mfrow=c(3,2))
...
EL DIC del modelo es de `r format(out_dinam_suav_100.dic,scipen=999)`.


```{r PlotRegresores_Dinam2_suav100,fig.width=12,fig.height=6,fig.cap='Regresores vs WTI: Modelo Dinámico con Intercepto Estático y Suavizamiento 100'}
#Predictions
par(mfrow=c(3,2))
# JPM_Dollar_Index vs. WTI
...
```{r tsWTI_Dinam_suav_100,fig.width=12,fig.height=6,fig.cap='Ajuste y Predicción: Modelo Dinámico con Intercepto Estático y Suavizamiento 100'}
#t vs y
par(mfrow=c(1,1))
plot_tsWTI(out.yp=out_dinam_suav_100.yp,pos_leg='topleft')
```

```{r tsBetas_Dinam_suav_100,message=FALSE, warning=FALSE, fig.width=12,fig.height=8,fig.cap='Coeficientes Estimados: Modelo Dinámico'}
#betas
par(mfrow=c(3,2))
...
EL DIC del modelo es de `r format(out_dinam_suav_100000.dic,scipen=999)`.
...
```{r tsBetas_Dinam_suav_100000,message=FALSE, warning=FALSE, fig.width=12,fig.height=8,fig.cap='Coeficientes Estimados: Modelo Dinámico'}
#betas
par(mfrow=c(3,2))
