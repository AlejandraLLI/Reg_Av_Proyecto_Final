...
#-Defining data-
data_dinam_suav_10 <- list("n"=n,"y"=c(datos$WTI[1:(n-3)],rep(NA,m)), "x"=select(datos, -WTI))
...
set.seed(semilla)
mod_dinam_suav_10.sim<-jags(data_dinam_suav_10,inits,parameters,model.file="Modelos/suavizamiento_lambda_10.txt",
