...
# Summary
out_dinam_transf_suav_1000.sum.t_beta<-cbind(out_dinam_transf_suav_1000.sum[grep("beta",rownames(out_dinam_transf_suav_1000.sum)),c(1,3,5,7)],modas_dinam_transf_suav_1000_beta)
