...
out_dinam_transf_suav_10.sum.t_beta<-cbind(out_dinam_transf_suav_10.sum[grep("beta",rownames(out_dinam_transf_suav_10.sum)),c(1,3,5,7)],modas_dinam_transf_suav_10_beta)
